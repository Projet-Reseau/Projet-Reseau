...
{	
	...
	private ImageButton btnAccepter = null;
	private ImageButton btnRejeter = null;
  ...
  private void InitViews()
  {
  	...
  	edSubject.setOnOpenKeyboard(new TouchEdit.OnOpenKeyboard()
    {
  	...
  	//Accepter un rendez-vous reviens a sauvegarder l'information
  	btnAccepter = (ImageButton)findViewById(R.id.btnAccepter);
  ...
  private void InitState()
  {
  	...
  	if (GetStartMode() == StartMode.CHOIX)
  	{
  		...
  		try{
  			...
  			while ((i = trololo.read()) != -1) {	// Lecture des caracteres 1 a 1
          lu.append( (char) i);
  			}
  			sujet=lu.toString();
  			trololo.close();
